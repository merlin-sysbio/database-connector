...
public class MySQLMultiThread implements Externalizable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -685885673781616326L;
	...
	//	public MySQLMultiThread(String host, String port,String db, String usr, String pwd){	
	//		
	//	}
	 ...
	 * @param database
	 */
	public MySQLMultiThread(String user, String password, String server, String port, String database) {
	 ...
	 * @param database
	 */
	public MySQLMultiThread(String user, String password, String server, int port, String database) {
